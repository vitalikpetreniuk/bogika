...
function initAnchorMenu() {
    $(".page-navigation").on("click", "a", (function (e) {
        ...
        var t = $(this).attr("href"), n = $(t).offset().top - 120;
...
function initCustomTextarea() {
    document.querySelectorAll("textarea").forEach((e => {
        e.style.height = e.setAttribute("style", "height: " + e.scrollHeight + "px"), e.classList.add("auto"), e.addEventListener("input", (t => {
...
$(document).ready((function () {
    initCloseBlock(), initFixedHeader(), initHeaderSearch(), initOpenBasket(), initMobileNav(), initSpinner(), initSlickSlider(), initSlickSlider2(), initSlickSlider3(), initSlickSlider4(), initCustomSelect(), initOpenBlock(), initAccordion(), initFixedBlock(), initScrollBtn(), initAnchorMenu(), initPlayVideo(), initCustomTextarea(), initTabs(), initRatingStars(), initSlickSliderProduct(), initLightBox()
}));