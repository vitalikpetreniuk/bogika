<?php
/**
 * Class WC_Email_Customer_New_Order file.
 *
...
if ( ! class_exists( 'WC_Email_Customer_New_Order', false ) ) :

	/**
	 * Customer On-hold Order Email.
	 *
	 * An email sent to the customer when a new order is created.
	 *
	 * @class       WC_Email_Customer_New_Order
	 * @extends     WC_Email
	 */
	class WC_Email_Customer_New_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Order on-hold123', 'woocommerce' );
