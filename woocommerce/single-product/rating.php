...
if ( $rating_count > 0 ) : ?>
	...
	<div class="woocommerce-product-rating rating-stars flexbox">
		<div class="stars stars5" itemprop="ratingValue">
		...
		<?php if ( comments_open() ) : ?>
			<?php //phpcs:disable ?>
			<a href="#reviews" class="woocommerce-review-link rating-text"
